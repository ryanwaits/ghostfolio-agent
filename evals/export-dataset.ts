...
const scenarios: EvalCase[] = [
  ...
  ...[
    ...
    [
      'How are my investments performing this year?',
  ...
  ...[
    ...
    ['Update my last AAPL buy to 15 shares', 'transaction_history,activity_manage'],
    ['Delete my most recent transaction', 'transaction_history,activity_manage'],
    [
